...
@@ -44,20 +43,17 @@ def is_valid_url(url):
...
@@ -67,82 +63,124 @@ def store_embeddings(input_path):
...
@@ -156,49 +194,26 @@ def query_chatbot(question):
...
if st.button("💬 Submit Query") and question:
    with st.spinner("🤔 Generating response... Please wait!"):
        try:
@@ -207,14 +222,16 @@ def query_chatbot(question):
        except Exception as e:
